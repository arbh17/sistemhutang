...
<body>
	<div class="header">
		...
		<h3 class="text-secondary font-weight-bold float-left logo">Sistem</h3>
		<h3 class="text-secondary float-left logo2">Hutang</h3>
		<a href="logout">
			<div class="logout">
	...
	<div class="main-content khusus">
		<div class="konten khusus2">
			<div class="konten_dalem khusus3">
					<h2 class="head" style="color: #4b4f58;">Pengurusan Hutang</h2>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalCenterTitle">Tambah Data Penghutang</h5>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="tanggal">Tarikh</label>
						...
						<div class="form-group">
							<label for="sumber">Status Hutang</label>
						...
						<div class="form-group">
							<label for="jumlahMasuk">Jumlah</label>
							<input type="text" class="form-control" id="jumlahMasuk" required>
						</div>
					</div>
					<!-- footer form -->
					<div class="modal-footer">
